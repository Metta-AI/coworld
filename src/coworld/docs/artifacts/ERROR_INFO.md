...
| `player_never_started`    | Kubernetes did not start every scheduled player process before the episode ended. This is infrastructure failure evidence and never identifies or blames a policy slot.                                                                                                                         |
