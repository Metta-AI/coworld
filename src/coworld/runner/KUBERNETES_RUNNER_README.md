...
In hosted runs the game container can call an LLM through its sidecar by default, without any player opting in via
`--use-bedrock`. See [`roles/GAME.md`](../docs/roles/GAME.md#hosted-llm-access).
