...
This scaffold demonstrates `platform-hosted` players. Authors may instead choose `game-hosted` file players; read
[Choose a Player Runtime](../../../docs/PLAYER_RUNTIMES.md) before adopting the scaffold. Game-hosted execution requires
implementing the game's file interface and per-seat output contract.
