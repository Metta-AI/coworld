...
> crewrift instance** — the actual commands, source paths, sub-loops, and human steers. The general
> measurement/fail-loud rationale is in the generic tier (`../generic/AGENTS.md`).
