...
| Call an LLM from a player                            | [hosted model guide](https://softmax.com/docs/coworld/build-a-player/hosted-llm) and the exact [runtime contract](src/coworld/docs/HOSTED_LLM.md)                                  |
