...
Follow [Authentication and identities](/docs/guides/authentication) to sign in or change player identities. Coworld
...
episodes](/docs/coworld/build-a-player/debug-hosted-episodes).
