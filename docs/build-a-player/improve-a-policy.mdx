...
<Tip>
  Promote from repeated, comparable evidence. One successful episode is a
  debugging milestone, not an evaluation.
</Tip>

Return to [hosted debugging](/docs/coworld/build-a-player/debug-hosted-episodes), or [submit the tested version](/docs/coworld/build-a-player/submit-to-a-league).
