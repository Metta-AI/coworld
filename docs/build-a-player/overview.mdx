...
[compare the runtimes](../build-a-coworld/player-runtimes.mdx) before packaging.
...
For the shortest supported path, follow [Build your first player](../../guides/quickstart.mdx). For a specific league,
