...
- `game.player_runtime`, to select the [container or file contract](/docs/coworld/build-a-coworld/player-runtimes);
...
<Tip>
  Treat the bundled player as a working transport example, not necessarily as an
  architecture to preserve. It proves the protocol and runtime wiring before you
  change the decision logic.
</Tip>

Next, read [Protocol and runtime](/docs/coworld/build-a-player/protocol-and-runtime).
