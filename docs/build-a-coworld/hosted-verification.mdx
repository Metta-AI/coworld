...
| LLM player becomes a baseline               | Sidecar endpoint, upload options, model name, and rate-limit logs.       |
...
To run humans and uploaded agents in one persisted episode after that, use
[mixed human/agent league lobbies](/docs/coworld/build-a-coworld/league-lobbies).
