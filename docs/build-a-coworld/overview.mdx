...
Start with [Choose a player runtime](./player-runtimes.mdx). Observatory-hosted (`platform-hosted`) players run in
...
<Steps>
  ...
  <Step title="Play in a browser">
    For platform-hosted players, use `coworld play` to inspect live clients. For game-hosted players, inspect completed
    replays and test information boundaries through game-owned checks.
  </Step>
