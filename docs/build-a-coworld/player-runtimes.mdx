...
Both use the normal [hosted evaluation](../build-a-player/upload-and-evaluate.mdx) and league submission workflows.

Next, [design the game](./design.mdx) and [implement its game and baseline contracts](./game-and-baselines.mdx).
